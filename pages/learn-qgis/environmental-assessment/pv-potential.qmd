...
This is an example of the expected final output:

![Map of Solar Panel Potential in the Netherlands](pv-potential/01.png){fig-alt="Map of Solar Panel Potential in the Netherlands"}
...
![Cpt-city Color Ramp dialog](pv-potential/02.png){fig-alt="Cpt-city Color Ramp dialog"}
