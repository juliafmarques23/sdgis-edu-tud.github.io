...
3.  In **Item Properties** for this new map, zoom/pan it out to show the wider context — e.g. Vlissingen's location within **Zeeland** or the **Netherlands** — using the `zeeland` layer
...
![](cartography_exercise/fig 5.png)
...
- Confirm the province/country boundary layer to use for the inset map (currently `[province-or-country-boundary]` placeholder), and that it's available in every student's Parts 1–4 starter projects. –\> **suggest using Zeeland, it's available on the data folder**
