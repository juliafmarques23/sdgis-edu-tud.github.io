...
- Confirm the real starter project filename, the bakeries layer filename, and that its CRS matches the project (EPSG:28992) --\> **done**
...
![](spatial_join_density_and_statistics/fig 5.png)
...
- Fill in the real project filename, bakeries layer filename, and output names (currently `[bracketed]` placeholders) once confirmed against the actual dataset. —\> **done**
