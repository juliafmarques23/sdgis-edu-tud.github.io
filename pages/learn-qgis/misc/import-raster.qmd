...
2.  Choose an elevation-appropriate colour ramp: **Color ramp → All Color Ramps/Create New Color Ramp... → cpt-city → `[ramp name, e.g. an elevation/terrain ramp under the cpt-city catalog]`**
