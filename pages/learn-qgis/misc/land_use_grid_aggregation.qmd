---
title: Aggregating Land Use Classes to a Regional Grid in Europe
description: Processing land use data into grids for analysis
categories:
- Data Preparation; Spatial Analysis
level: Intermediate
level_code: 2.0
level_color: '#1F78B4'
date: .na.character
...
-   **Netherlands 2×2 km Reference Grid** – Regular grid covering the Netherlands
    -   You can import it from the data folder. Alternatively, to create it, you can follow the tutorial on [how to create a fishnet](pages/spatial_data_preparation/creating_fishnet.qmd)
...
**Bounding Box (GDAL format, in EPSG:3035 coordinates):**
CHECK
```         
