...
- Per the course plan, BBG + CBS neighbourhoods are already clipped to the study area and provided pre-loaded/ready — confirm the starter project reflects that so students don't need to clip anything themselves –\> **done**
:::
...
- Confirm `bbg` and `[cbs-neighbourhoods]` are pre-clipped to the Vlissingen study area in the distributed starter project, per the Part 1 data prerequisites in `pages/courses/mscu_q1.qmd` — students should not need to clip anything themselves in this 30-minute slot. –\> **done**
- Fill in the real project filename, CBS neighbourhoods filename, and the BBG category field name (currently `[bracketed]` placeholders) once finalised. –\> **done**
- Confirm the CRS answer in Step 1.2 against the actual starter project. –\> **done**
