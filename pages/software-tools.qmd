...
::: {.callout-tip appearance="minimal" icon="true"}
**Website:** <https://geodacenter.github.io/index.html>\
**Platform:** Windows, macOS, Linux\
**Use it for:** Exploratory spatial data analysis, spatial autocorrelation, regression modeling
:::
...
![](/images/logos/Flourish.png){.tool-logo}

**Flourish** lets users create interactive visualizations with minimal coding, ideal for storytelling and journalism. Flourish [was created](https://flourish.studio/company/#story) to enable everyone to tell stories with data. Launched in 2018, the tool is used by a huge community of creators to inform tens of millions of viewers every day.
...
![](/images/logos/rstudio.png){.tool-logo}
